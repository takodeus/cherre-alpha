  ...
  return (
    <section id="path" className="section-gradient relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1120px] mx-auto px-4 sm:px-6 md:px-10 py-14 sm:py-20 md:py-24">
        <span className="font-display text-[10px] sm:text-[11px] font-bold tracking-[2.2px] uppercase text-luna-teal block mb-4 text-center">
          From Audit-Ready to Agent-Ready
        </span>

        <h2 className="font-display text-[22px] sm:text-[clamp(24px,3.6vw,42px)] font-extrabold leading-[1.12] text-white mb-8 sm:mb-12 max-w-[700px] mx-auto text-center">
          Every Path Leads to
          <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-2">
              ...
              <div key={i}>
                ...
                >
                  <div className="flex flex-col sm:flex-row">
                    <div className="sm:w-24 shrink-0 bg-white/[0.03] sm:border-r border-b sm:border-b-0 border-white/[0.06] flex sm:flex-col justify-between sm:justify-center px-3 py-2 sm:py-3">
                      <span className="font-display text-[10px] font-bold tracking-[1.4px] uppercase text-luna-very-muted">
                        {tier.label}
                      </span>
                      <span className="font-display text-base sm:text-lg font-bold text-white leading-tight">
                        {tier.name}
                      </span>
                    </div>
                    <div className="px-3 sm:px-4 py-3 flex-1">
                      ...
                      <p className="text-[13px] sm:text-sm text-luna-muted leading-relaxed">
                        {tier.desc}
                      </p>
                    </div>
                  </div>
            ...
            {/* Destination */}
            <div className="bg-luna-pink rounded-lg px-4 sm:px-6 py-4 sm:py-5">
              <div className="font-display text-lg sm:text-xl font-bold text-white mb-1">
                Cherre Alpha
              </div>
              <div className="text-[13px] sm:text-sm text-white/70 leading-relaxed">
          ...
          <div className="space-y-3">
            {STAGES.map((stage, i) => (
              <div key={i} className="border border-white/[0.08] bg-white/[0.03] rounded-lg overflow-hidden">
                <div className="bg-white/[0.04] border-b-2 border-b-luna-pink px-4 sm:px-5 py-3 flex items-baseline gap-3">
                ...
                <div className="px-4 sm:px-5 py-3 sm:py-4">
                  <p className="text-[13px] sm:text-sm text-luna-muted leading-relaxed mb-3">
                    {stage.body}
                  </p>
                  <div className="bg-white/[0.04] rounded-lg px-3 py-2.5">
                    ...
                    <p className="text-[13px] sm:text-sm text-luna-muted">{stage.leaveBehinds}</p>
                  </div>
                </div>
              </div>
            ))}
