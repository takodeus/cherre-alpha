  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] backdrop-blur-md" style={{ background: "rgba(13,1,23,0.92)" }}>
      <div className="max-w-[1120px] mx-auto flex items-center justify-between px-6 md:px-10 h-14">
        ...
        <span className="hidden md:block font-mono text-[10px] tracking-[0.18em] uppercase text-luna-muted">
          The Governed Data Layer for Enterprise AI
        </span>

        <a
          href="#contact"
          className="border border-luna-pink/40 text-white px-5 py-2 text-xs font-medium tracking-[0.08em] uppercase rounded-full hover:bg-luna-pink/15 transition-all"
